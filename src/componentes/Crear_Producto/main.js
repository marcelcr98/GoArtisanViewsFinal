					...
					<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                        ...
                        <h4 class="mtext-105 cl2 txt-center p-b-30">
							...
							<div class="bor8 m-b-20 how-pos4-parent">
								<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="text" placeholder="Nombre producto:"/>
								<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="text" placeholder="Precio"/>
